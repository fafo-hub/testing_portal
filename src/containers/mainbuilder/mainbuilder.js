...
import Sponsored_Lease from "../MainContent/Ecommerce/sponsored_lease/Sponsored_Lease";
import User_Account from "../MainContent/Ecommerce/user_account/User_Account";
import Quick_Lease from "../MainContent/Ecommerce/quick_lease/Quick_Lease";
...
import Request from "../MainContent/Lease/Request";
import RequestDetails from "../MainContent/Lease/Details/RequestDetails";
  ...
  render() {
    return (
        <Switch>
          ...
          />
          <Route path="/sponsored_lease" component={Sponsored_Lease} />
          <Route path="/user_account" component={User_Account} />
          <Route path="/quick_lease" component={Quick_Lease} />
          ...
          <Route path="/lease-request/:id" component={RequestDetails} />
