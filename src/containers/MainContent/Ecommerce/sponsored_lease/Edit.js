                                          ...
                                          <div className="row">
                                              ...
                                              <div className="form-group">
                                                  ...
                                                  <div className="form-group">
                                                      ...
                                                      <input id="productname" name="productname" onChange={(e) => handleChange("price", e.target.value)} value = {input.price} type="text" className="form-control" />
                                                  </div>
                                              </div>
                                          ...
                                          <div className="row">
                                              <div className="col-sm-6">
                                                  <div className="form-group">
                                                      ...
                                                      <input id="manufacturerbrand" name="manufacturerbrand" onChange={(e) => handleChange("duration", e.target.value)} value={ (input.price / 1000) +" months"} type="text" className="form-control" />
                                                  </div>
                                                  <div className="form-group">
