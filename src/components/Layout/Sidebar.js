...
import $ from "jquery";
import ScrollPage from "../../containers/MainContent/Ecommerce/scrollPage";
    ...
    render() {
        return (
            ...
            <div className="topbar-left">
                <div className="">
                    <Link to="/" className="logo"><img src="assets/images/Group 2001.png" height="36" alt="logo" /></Link>
                </div>
            </div>
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li className={this.state.eco_menu ? 'has_sub active-menu nav-active' : 'has_sub'}>
                            <Link to="#" onClick={()=> this.setState({ eco_menu: !this.state.eco_menu,dashboard_menu : false, email_menu : false, ui_menu: false,form_menu: false,chart_menu: false,table_menu: false,icon_menu: false,map_menu: false,auth_menu: false,extra_menu: false,emt_menu: false }) }   className={this.state.Tab === 'eco' ? 'waves-effect active-menu':'waves-effect'}><i className="mdi mdi-cart-outline"></i><span> Product Catalogue <span className="pull-right"><i className="mdi mdi-chevron-right"></i></span> </span></Link>
                            <ul className="list-unstyled" style={{display: this.state.eco_menu ? 'block' : 'none' }}>
                                <li><Link className={this.state.SubTab === 'quick_lease' ? 'active-menu':''} onClick={this.setActiveTab.bind(this, 'eco','quick_lease','')}  to="quick_lease">Quick Lease</Link></li>
                                <li><Link className={this.state.SubTab === 'Sponsored_Lease' ? 'active-menu':''} onClick={this.setActiveTab.bind(this, 'eco','Sponsored_Lease','')}  to="Sponsored_Lease">Sponsored Lease</Link></li>
                                <li><Link className={this.state.SubTab === 'user_account' ? 'active-menu':''} onClick={this.setActiveTab.bind(this, 'eco','user_account','')}  to="user_account">Users</Link></li>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <li  className={this.state.ui_menu ? 'has_sub active-menu nav-active' : 'has_sub'}>
                            <Link to="#"  onClick={()=> this.setState({ ui_menu: !this.state.ui_menu, email_menu : false, dashboard_menu: false,form_menu: false,chart_menu: false,table_menu: false,icon_menu: false,map_menu: false,auth_menu: false,extra_menu: false,eco_menu: false,emt_menu: false }) }  className={this.state.Tab === 'ui' ? 'waves-effect active-menu':'waves-effect'}><i className="mdi mdi-buffer"></i> <span> Lease <span className="pull-right"><i className="mdi mdi-chevron-right"></i></span> </span> </Link>
                            <ul className="list-unstyled" style={{display: this.state.ui_menu ? 'block' : 'none' }}>
                                <li><Link className={this.state.SubTab === 'buttons' ? 'active-menu':''} onClick={this.setActiveTab.bind(this, 'ui','buttons','')} to="buttons">Sponsored Lease</Link></li>
                                <li><Link className={this.state.SubTab === 'colors' ? 'active-menu':''} onClick={this.setActiveTab.bind(this, 'ui','colors','')} to="colors">Quick Loan</Link></li>
